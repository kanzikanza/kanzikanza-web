...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        // UserUniteDtos.ValidateResponse validateResponse =
        // kakaoApi.getValidUser(token);
        // UserModel userModel =
        // userService.findUserModelByUserKakaoSerial(validateResponse.getId());
        // UserPrincipal userPrincipal =
        // jwtToPrincipalConverter.convertUserModel(userModel);
        // UserPrincipalAuthenticationToken userPrincipalAuthenticationToken = new
        // UserPrincipalAuthenticationToken(userPrincipal);
